export class Engine {
  ...
  private handleRun: FrameRequestCallback;

  constructor(time_step: number, update: Function, render: Function) {
    ...
    this.time = 0; // The most recent timestamp of loop execution.
    ...
    this.handleRun = (time_step: number) => {
      this.run(time_step);
    };
  }
